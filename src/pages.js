export const PATCH = {
  ...
  "tr": [
    ...
    },
    {
      ...
      "version": "1.1",
      "items": [
        "Dereceli Sıralamalar",
        "Hava Modifikatörleri",
        "Geri Dönüş Avantajları"
      ]
    },
    {
...
export function creditsPage(lang) {
  ...
  if (CREDITS_TITLES[lang]) {
    title = CREDITS_TITLES[lang];
  }
  return { title: title, body: CREDITS_BODY };
}
