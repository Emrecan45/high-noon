const STRINGS = {
  en: {
    ...
    helpHtml:
      ...
      "<p><strong>Ranked & shop.</strong> Pick a gunslinger name, climb the Elo leaderboard in ranked duels, and earn coins after every match (ranked pays far more than the AI) to buy outfits at the store.</p>",
    ...
    accountTitle: "Pick your gunslinger name",
    accountHint: "This name shows on the leaderboard and to your opponents. 3 to 16 characters: letters, digits, spaces, _ . -",
    accountCreate: "CREATE",
    accountTaken: "That name is already taken.",
    accountInvalid: "3 to 16 characters: letters, digits, spaces, _ . -",
    accountError: "Could not create the account. Try again.",
    ...
    searchRankedTitle: "Looking for a ranked opponent…",
  ...
  fr: {
    ...
    helpHtml:
      ...
      "<p><strong>Classé & boutique.</strong> Choisis un nom de pistolero, grimpe au classement Elo en duel classé, et gagne des pièces à chaque match (le classé rapporte bien plus que l'IA) pour acheter des tenues à la boutique.</p>",
    ...
    btnShop: "BOUTIQUE",
    btnBoard: "CLASSEMENT",
    accountTitle: "Choisis ton nom de pistolero",
    accountHint: "Ce nom apparaît au classement et face à tes adversaires. 3 à 16 caractères : lettres, chiffres, espaces, _ . -",
    accountCreate: "CRÉER",
    accountTaken: "Ce pseudo est déjà pris.",
    accountInvalid: "3 à 16 caractères : lettres, chiffres, espaces, _ . -",
    accountError: "Impossible de créer le compte. Réessaie.",
    shopTitle: "Bazar du duelliste",
    shopCoins: "{n} 🪙",
    ...
    searchRankedTitle: "Recherche d'un adversaire classé…",
    resultRanked: " Elo : {elo} ({delta}). +{coins} 🪙.",
    resultCoins: " +{coins} 🪙.",
