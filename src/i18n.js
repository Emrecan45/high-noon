const STRINGS = {
  en: {
    ...
    helpHtml:
      ...
      "<p><strong>Dodge.</strong> Once per round, press Q or D (or A/E) to dive sideways. You can still shoot mid-dive, but your aim shakes hard. If your opponent shoots during your roll, he misses. If he waits it out, you're at his mercy.</p>" +
      ...
      "<p><strong>Round modifiers.</strong> Dusk, fog, long range, gusts: every round changes the conditions. First to 3 rounds wins.</p>" +
    ...
    "mod.noon.desc": "Perfect conditions. May the fastest win.",
    "mod.dusk.name": "DUSK",
    "mod.dusk.desc": "Night falls, only silhouettes remain.",
    "mod.fog.name": "FOG",
    "mod.fog.desc": "A thick fog drowns the street.",
    "mod.range.name": "LONG RANGE",
    "mod.range.desc": "Twenty-six meters between the duelists.",
    "mod.wind.name": "GUSTS",
  ...
  fr: {
    ...
    helpHtml:
      ...
      "<p><strong>Esquive.</strong> Une fois par manche, appuie sur Q ou D (ou A/E) pour plonger sur le côté. Tu peux tirer pendant la roulade, mais ta visée tremble fort. Si l'adversaire tire pendant ta roulade, il te rate. S'il attend la fin, tu es à sa merci.</p>" +
      ...
      "<p><strong>Manches à modificateurs.</strong> Crépuscule, brume, longue portée, rafales : chaque manche change les conditions. Premier à 3 manches gagnées.</p>" +
    ...
    "mod.noon.desc": "Conditions parfaites. Que le plus rapide gagne.",
    ...
    "mod.range.name": "LONGUE PORTÉE",
    "mod.range.desc": "Vingt-six mètres séparent les duellistes.",
