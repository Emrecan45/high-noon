const STRINGS = {
  en: {
    ...
    helpHtml:
      ...
      "<p><strong>Ranked & outfits.</strong> You get a gunslinger name automatically (your CrazyGames name if you're logged in). Click your card at the top left to rename yourself and spend your coins on outfits. Climb the Elo leaderboard in ranked duels (they pay far more than the AI), or challenge a friend with an invite link - friendly duels are just for honor.</p>",
    ...
    friendHint: "Send this link to your friend - the duel starts as soon as they arrive. Friendly duels: no Elo, no coins.",
  ...
  fr: {
    ...
    friendHint: "Envoie ce lien à ton ami - le duel démarre dès qu'il arrive. Duel amical : ni Elo, ni pièces.",
  ...
  es: {
    ...
    friendHint: "Envía este enlace a tu amigo - el duelo empieza en cuanto llegue. Duelo amistoso: ni Elo, ni monedas.",
  ...
  de: {
    ...
    friendHint: "Schick diesen Link deinem Freund - das Duell startet, sobald er ankommt. Freundschaftsduell: kein Elo, keine Münzen.",
  ...
  pt: {
    ...
    helpHtml:
      ...
      "<p><strong>Ranqueada e trajes.</strong> Você recebe um nome de pistoleiro automaticamente (seu nome do CrazyGames se estiver logado). Clique no seu cartão no canto superior esquerdo para se renomear e gastar suas moedas em trajes. Suba no ranking Elo nos duelos ranqueados (pagam muito mais que a IA), ou desafie um amigo com um link de convite - duelos amistosos valem só a honra.</p>",
    ...
    friendHint: "Envie este link para seu amigo - o duelo começa assim que ele chegar. Duelo amistoso: sem Elo, sem moedas.",
  ...
  ru: {
    ...
    friendHint: "Отправь эту ссылку другу - дуэль начнётся, как только он придёт. Дружеская дуэль: без Эло и монет.",
    ...
    resultRanked: " Эло: {elo} ({delta}). +{coins} 🪙.",
    resultCoins: " +{coins} 🪙.",
  ...
  tr: {
    ...
    friendHint: "Bu bağlantıyı arkadaşına gönder - o gelir gelmez düello başlar. Dostluk düellosu: Elo yok, altın yok.",
