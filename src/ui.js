...
export function createUi() {
  ...
  function matchEnd(title, detail, onRematch, onMenu) {
    ...
    if (typeof detail === "string") {
      ...
      if (typeof detail.reward === "string" && detail.reward !== "") {
        const reward = document.createElement("div");
        reward.className = "me-reward show";
        reward.id = "matchend-reward";
        reward.innerHTML = detail.reward;
        node.appendChild(reward);
      } else if (detail.reserveReward === true) {
        const reward = document.createElement("div");
        reward.className = "me-reward pending";
        reward.id = "matchend-reward";
        node.appendChild(reward);
      }
